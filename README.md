# Agentic Set (ex AI Agent Resources Collection)

> **[AGENT INSTRUCTION]**
> You are reading the root index of `agentic-set`, a Knowledge Base and Tool Directory designed for AI agents (like Antigravity or Goose) and their human operators.
> **IMPORTANT**: This repository is NOT an orchestrator. It is an "App Store" of skills, standards, and patterns. To orchestrate a project using the files here, you must use **The Architect** skill.
...
*Note: The legacy files that originally composed this directory before refactoring to the modern SEED architecture (incorporating ICM) are archived in the `/old/` folder for historical preservation.*
