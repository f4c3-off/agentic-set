...
- **[Dataview](https://github.com/blacksmithgu/obsidian-dataview)** `#tool:obsidian #archetype:knowledge_base #purpose:management`: Live query engine for Obsidian.
...
- **[Templater](https://github.com/SilentVoid13/Templater)** `#tool:obsidian #archetype:knowledge_base #purpose:management`: Advanced templating language.
...
- **[QuickAdd](https://github.com/chhoumann/quickadd)** `#tool:obsidian #archetype:knowledge_base #purpose:management`: Quick creation of notes and tasks.
...
- **[Folder Note](https://github.com/aidenlx/alx-folder-note) / [Waypoint](https://github.com/IdreesInc/Waypoint)** `#tool:obsidian #archetype:knowledge_base #purpose:management`: Visual folder indexes.
...
- **[Linter](https://github.com/platers/obsidian-linter)** `#tool:obsidian #archetype:knowledge_base #purpose:management`: Automatic Markdown formatter.
...
- **[Omnivore](https://github.com/omnivore-app/obsidian-omnivore) / [Readwise Official](https://obsidian.md/plugins?id=readwise-official)** `#tool:obsidian #workflow:raw_ingestion #purpose:sync`: Highlight and article sync.
...
- **[JSON/CSV Importer](https://github.com/farux/obsidian-auto-card-link)** *(and similar data-ingestion tools)* `#tool:obsidian #workflow:raw_ingestion #purpose:sync`: 
...
- **[Smart Connections](https://github.com/brianpetro/obsidian-smart-connections)** `#tool:obsidian #archetype:operational_pipeline #purpose:automation`: Local vector search engine and LLM chat for the vault.
...
- **[Copilot (Bramises/Logseq)](https://github.com/logseq-copilot/copilot-obsidian)** `#tool:obsidian #archetype:operational_pipeline #purpose:automation`: Native AI chat interface for Obsidian.
...
- **[Local REST API](https://github.com/coddingtonbear/obsidian-local-rest-api)** `#tool:obsidian #archetype:operational_pipeline #purpose:automation`: Exposes local vault APIs.
...
- **[Text Extractor](https://github.com/scambier/obsidian-text-extractor)** + **[Omnisearch](https `#tool:obsidian #archetype:operational_pipeline #purpose:automation`://github.com/scambier/obsidian-omnisearch)**: OCR and deep search.
...
- **[Excalidraw](https://github.com/zsviczian/obsidian-excalidraw-plugin)** `#tool:obsidian #workflow:osint #purpose:research`: Integrated virtual whiteboard.
...
- **[Graph Analysis](https://github.com/SkepticMystic/graph-analysis)** `#tool:obsidian #workflow:osint #purpose:research`: Complex network analysis (NLP algorithms, Co-citations).
...
- **[Obsidian Leaflet](https://github.com/javalent/obsidian-leaflet)** `#tool:obsidian #workflow:osint #purpose:research`: Interactive maps within notes.
