...
- **[STORM (Stanford)](https://github.com/stanfordnlp/storm)** `#workflow:ricerca_analitica`: Framework for asynchronous analytical research (OSINT) (digital experts debating and synthesizing).
