...
## Courses & Guides
- **[D2L (Dive into Deep Learning)](https://github.com/d2l-ai/d2l-en)**: Interactive Deep Learning book with code and mathematics.
...
- **[Hello Agents](https://github.com/datawhalechina/hello-agents)**: "Build agents from scratch", practical course on the principles of intelligent agents.
...
- **[Learn Anything](https://learn-anything.xyz/)**: Tree-based search engine for educational mind maps.
...
- **[Claude Code Playbook](https://duet.so/guides/claude-code-playbook-building-a-skill-first-workflow-that-actually-sticks)**: Guide to "skill-first" workflows with Claude Code without writing code.
...
- **[AI Engineering From Scratch](https://github.com/rohitg00/ai-engineering-from-scratch)**: Practical guide (Learn it. Build it. Ship it.).
...
- **[Agents From Scratch](https://agentsfromscratch.com/)**: Course for building AI agents locally without frameworks.
...
- **[LLM Step by Step](https://github.com/P-Slark/LLM-Step-by-Step)**: PyTorch guide inspired by Stanford's CS336.
...
- **[Don't Feed The AI](https://github.com/zeroc00I/DontFeedTheAI)**: Transparent anonymization proxy for pentesting and security (removes PII and IP).
...
## Papers & Research
- **[Context Engineering 2.0](https://arxiv.org/pdf/2510.26493v1)**: Paper on context management methodology.
...
- **[ICM: Interpretable Context Methodology (Folder Structure as Agent Architecture)](https://arxiv.org/pdf/2603.16021v2)**: Paper (Van Clief & McDermott) on using the file system and Markdown as orchestration code.
...
- **[HarnessX: A Composable, Adaptive, and Evolvable Agent Harness Foundry](https://arxiv.org/abs/2606.14249)**: Paper on dynamic creation of agent harnesses.
...
## Articles & Maps
- **[Andrej Karpathy's LLM Wiki pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f)**: Pattern for building LLM-maintained knowledge bases.
...
- **[L'Agente non ha una forma](https://pinperepette.github.io/signal.pirate/articoli/l-agente-non-ha-una-forma.html?t=d)**: Italian theoretical article ("The Agent has no shape").
...
- **[The Anatomy of an Agent Harness](https://www.langchain.com/blog/the-anatomy-of-an-agent-harness)**: LangChain article on harnesses.
...
- **[Gemini Memoria Persistente](https://www.smartworld.it/news/gemini-memoria-persistente-import-chat-chatgpt-claude.html)**: News on cross-platform persistence in Gemini.
...
- **[Agentic AI Landscape](https://github.com/antgroup/agentic-ai-landscape)**: Overview of the agentic ecosystem.
...
- **[CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S)**: Leak of original System Prompts from major models (Claude, ChatGPT).
...
- **[OBLITERATUS](https://github.com/elder-plinius/OBLITERATUS)**: Repository on extreme jailbreak techniques.
